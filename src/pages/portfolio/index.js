  ...
  return (
    ...
    <>
      ...
      <LayoutOne topbar={true}>
        <div class="pt-120 pb-90 section-title-area ltn__section-title-2--- text-center"><h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Our Works</h6><h1 class="section-title">Gallery</h1></div>
