              ...
              <div className="about-us-img-wrap about-img-left">
                ...
                <div className="about-us-img-info about-us-img-info-2 about-us-img-info-3">
                  <div className="ltn__video-img ltn__animation-pulse1">
                    {/* <img src="/img/others/8.jpg" alt="video popup bg image" /> */}
                    <button
              ...
              <div className="about-us-info-wrap">
                <div className="section-title-area mb-20">
                  ...
                  <h1 className="section-title">
                   Your Vision, <br />Our Foundation<span>.</span>
                  </h1>
                  <p>
                ...
                <div className="ltn__callout bg-overlay-theme-05  mt-30">
                  <p>
                    Every day you delay your project is a day lost in potential revenue. Poor planning or choosing the wrong partner can impact your investment returns significantly. 
                  </p>
                </div>
